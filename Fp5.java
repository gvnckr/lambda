...
//Plain Old Java Object
        ...
        System.out.println(" kurs adlarini iceriyor mu :"+kursAdlarindabiriniİceriyorMU(coursesList,"turkhis"));
        ortalamasiEnYuksekKursuYazdir(coursesList);
...
public static void ortalamasiEnYuksekKursuYazdir(List<Courses>list){
  String sonuc=   list.stream().sorted(Comparator.comparing(Courses::getAverageScore).reversed()).findFirst().get().getCourseName();
    System.out.println(sonuc);
list.stream().sorted(Comparator.comparing(Courses::getAverageScore).reversed()).findFirst().get().getCourseName();
